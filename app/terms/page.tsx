    ...
    <main className="inner-page">
      ...
      <article className="legal-shell">
        ...
        <div className="legal-card dashboard-card">
          ...
          <section><h2>{t("Account responsibility", "مسئولیت حساب")}</h2><p>{t("Anonymous members may use a private username and password without providing a real name or email, but they must also copy or download the recovery code provided during signup and keep it private. Verified email members may add username-and-password access later. Adding a login method keeps the same inventories, analytics, membership, and billing connection. Do not share passwords, recovery codes, or email sign-in codes with a sponsor or anyone else; use the separate inventory-sharing controls.", "اعضای ناشناس می‌توانند بدون ارائه نام واقعی یا ایمیل از نام کاربری و رمز عبور خصوصی استفاده کنند، اما باید کد بازیابی ارائه‌شده هنگام ثبت‌نام را نیز کپی یا دانلود کرده و خصوصی نگه دارند. اعضای ایمیلی می‌توانند بعداً ورود با نام کاربری و رمز عبور را اضافه کنند. افزودن روش ورود، همان ترازنامه‌ها، تحلیل‌ها، عضویت و اتصال پرداخت را حفظ می‌کند. رمز عبور، کد بازیابی یا کد ورود ایمیلی را با حامی یا هیچ شخص دیگری به اشتراک نگذارید؛ از کنترل‌های جداگانه اشتراک‌گذاری ترازنامه استفاده کنید.")}</p></section>
