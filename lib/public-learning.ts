...
export const learningHubCopy: Record<Language, {
  ...
  en: {
    ...
    ctaText: "Try the demo before creating an anonymous username-and-password account with a recovery code, or an email-based account.",
  ...
  es: {
    ...
    ctaText: "Prueba la demostración antes de crear una cuenta anónima con nombre de usuario, contraseña y código de recuperación, o una cuenta con correo electrónico.",
  ...
  fa: {
    ...
    ctaText: "پیش از ساخت حساب ناشناس با نام کاربری، رمز عبور و کد بازیابی یا حساب ایمیلی، نسخه آزمایشی را امتحان کنید.",
